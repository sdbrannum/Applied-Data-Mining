...
```{r load_data}
prescribers<-read.csv("D:/OneDrive/SP18/Applied Data Mining - BIA 6301 BSB/Week1 - Naive Bayes, KNN/prescribers.csv") #or you can fully specify the pathname in the read command
