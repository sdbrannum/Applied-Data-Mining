...
groceries <- read.transactions("D:/OneDrive/SP18/Applied Data Mining - BIA 6301 BSB/HW3/HW3/HW3/groceries.csv", sep = ",") #9,835 transactions with 169 products.
dim(groceries)
```
...
```{r grocery_rule} 
groceryrules <- apriori(groceries, parameter = list(support =0.001, confidence = 0.8, minlen = 2)) 
```
